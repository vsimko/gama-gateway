...
version:  2008-08-04 (Addition: added Placeholder check to xGroupGraphPattern method)
*/
...
class ARC2_SPARQLParser extends ARC2_TurtleParser {
  ...
  function xFunctionCall($v) {
    ...
    // changed by Viliam Simko (added "!= 0")
      if ((list($sub_r, $sub_v) = $this->xArgList($sub_v)) && $sub_r != 0) {

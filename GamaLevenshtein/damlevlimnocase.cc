...
extern "C" {
	my_bool		damlevlimnocase_init(UDF_INIT *initid, UDF_ARGS *args,
	                             char *message);
	void			damlevlimnocase_deinit(UDF_INIT *initid);
	longlong		damlevlimnocase(UDF_INIT *initid, UDF_ARGS *args,
...
******************************************************************************/
my_bool damlevlimnocase_init(UDF_INIT *initid, UDF_ARGS *args, char *message)
{
	int *workspace;
...
******************************************************************************/
longlong damlevlimnocase(UDF_INIT *initid, UDF_ARGS *args, char *is_null,
                     char *error)
{
